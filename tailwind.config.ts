    ...
    extend: {
      ...
      colors: {
        ...
        gallery: {
          ...
          soft: "hsl(var(--gallery-soft))",
          terracotta: "hsl(var(--gallery-terracotta))",
          gold: "hsl(var(--gallery-gold))",
        },
        listening: {
          room: "hsl(var(--listening-room))",
          foreground: "hsl(var(--listening-foreground))",
          card: "hsl(var(--listening-card))",
          border: "hsl(var(--listening-border))",
          muted: "hsl(var(--listening-muted))",
          accent: "hsl(var(--listening-accent))",
        },
        sidebar: {
